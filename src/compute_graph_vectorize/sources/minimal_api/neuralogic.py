...
from compute_graph_vectorize.sources.base import LayerDefinition, LayerType, WeightDefinition, is_weighted
...
from compute_graph_vectorize.sources.minimal_api.internal.neuralogic import (
    JavaNeuron,
    JavaWeight,
