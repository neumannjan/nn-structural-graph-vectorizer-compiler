...
from compute_graph_vectorize.engines.torch.settings import TorchReduceMethod
...
class SegmentCSR(_ScatterBase):
    def __init__(self, counts: Sequence | torch.Tensor | np.ndarray, indptr: torch.Tensor, reduce: ReductionDef) -> None:
        ...
        from compute_graph_vectorize.engines.torch.segment import SEGMENT_CSR_FUNC
