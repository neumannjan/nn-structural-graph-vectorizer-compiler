      ...
      layers=OrderedDict([
        ("l1__wr", Layer(
          ...
          base=LinearLayerBase(
            lifts=None,
            input=Refs(types=[0, 0, 0, 0, 0, 0], layer_ids=["a__f", "b__f", "a__f", "a__f", "b__f", "a__f"], ordinals=[0, 0, 0, 0, 0, 0]),
            weight=Refs(types=[1, 1, 1, 1, 1, 1], layer_ids=["001", "002", "004", "001", "002", "004"],
